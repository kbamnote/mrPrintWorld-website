/**
 * Testimonials — brief §12, Section 8.
 *
 * ⚠️  SAMPLES. These are clearly-marked placeholders (`sample: true`) written to
 * demonstrate the layout. Replace with REAL, named, permission-cleared client
 * quotes — ideally with a measurable result — before launch. The UI shows a
 * small "Sample" marker on any item flagged `sample`.
 */
...
export const testimonials = [
  ...
  },
  {
    ...
    result: 'Unified brand across every surface',
  },
]
