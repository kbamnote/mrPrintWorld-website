 ...
 * `title` captions are editable — only the two clearly legible awards are named;
 * replace the "Industry recognition" placeholders with the real award titles.
 */
export const achievements = [
  { src: awardsFive, title: 'Industry recognition' },
