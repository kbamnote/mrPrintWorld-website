...
export default function Achievements() {
  useSeo({
    title: 'Awards & Achievements | MRPrint World Pvt. Ltd., Nagpur',
    description:
      'Awards and industry recognition earned by MRPrint World Pvt. Ltd. and founder Mr. Abid M. Khan — including the Vidarbha Udyog Ratna Puraskar 2024.',
    path: '/achievements',
    jsonLd: breadcrumbLd([
      { name: 'Home', path: '/' },
            ...
            {achievements.map((a, i) => (
              ...
              >
                <span className="block aspect-[3/4] overflow-hidden">
                  <img
                    src={a.src}
                    alt={`MRPrint World Pvt. Ltd. — ${a.title}`}
                    loading="lazy"
      ...
      {active != null && (
        ...
        >
          <img
            ...
            alt={`MRPrint World Pvt. Ltd. — ${achievements[active].title}`}
