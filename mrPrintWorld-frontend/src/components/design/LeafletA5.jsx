...
export default function LeafletA5({ v, theme, fonts, logo, photo }) {
  ...
  return (
    <svg viewBox="0 0 154 216" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
      ...
      <FitText maxWidth="32" x="122" y="65" textAnchor="middle" fontFamily={fonts.display} fontSize="7.5" fill="#ffffff">
        {v.offer}
      </FitText>

      <FitText maxWidth="130" x="12" y="112" fontFamily={fonts.display} fontSize="13" fill="#141A21">
        {v.headline}
      </FitText>
      <FitText maxWidth="130" x="12" y="123" fontFamily={fonts.body} fontSize="4.4" fill="#34403b">
        {v.subhead}
      </FitText>
      ...
      {points.map((point, i) => (
        <g key={i}>
          ...
          <FitText maxWidth="122" x="19.5" y={142.6 + i * 13} fontFamily={fonts.body} fontSize="4.3" fill="#141A21">
            {point}
          </FitText>
        </g>
      ))}
      ...
      {logo ? <image href={logo} x="108" y="188" width="34" height="14" preserveAspectRatio="xMaxYMid meet" /> : null}
      <FitText maxWidth="90" x="12" y="197" fontFamily={fonts.display} fontSize="7" fill="#ffffff">{v.company}</FitText>
      <FitText maxWidth="55" x="12" y="206" fontFamily={fonts.body} fontSize="4" fill="#ffffff" fillOpacity="0.9">
        {v.phone}
      </FitText>
      <FitText
        maxWidth="60" x="142" y="206" textAnchor="end" fontFamily={fonts.body} fontSize="4"
